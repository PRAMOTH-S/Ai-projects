...
## 📌 Overview
Thi project  implements a machine learning pipeline to predict the presence of heart disease using clinical parameters.  
...
## 🎯 Objectives
- Build a reliable classification model for heart disease prediction  
- Apply standard ML workflow (data → training → evaluation → prediction)  
- Create a reusable and scalable codebase  
